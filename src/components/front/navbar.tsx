                ...
                <div className="flex items-center gap-x-4">
                    <div className="relative h-[44px]">
                        <input
                            ...
                            className="h-full w-full text-base text-[#131313] placeholder:text-[#949494] pl-10 bg-[#F0F0F0] rounded-[42px] peer"
                        />
                        <div className="absolute top-1/2 left-3 transform -translate-y-1/2 text-[#949494] peer-focus:text-[#131313]">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.58317 17.5001C13.9554 17.5001 17.4998 13.9557 17.4998 9.58341C17.4998 5.21116 13.9554 1.66675 9.58317 1.66675C5.21092 1.66675 1.6665 5.21116 1.6665 9.58341C1.6665 13.9557 5.21092 17.5001 9.58317 17.5001Z" stroke="currentcolor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M18.3332 18.3334L16.6665 16.6667" stroke="currentcolor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    </div>
                    <button type="button">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M14.3599 14V17.55" stroke="#292D32" stroke-width="1.5" stroke-linecap="round" />
                    ...
                    <button type="button">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M15.3299 18.8201C15.3299 20.6501 13.8299 22.1501 11.9999 22.1501C11.0899 22.1501 10.2499 21.7701 9.64992 21.1701C9.04992 20.5701 8.66992 19.7301 8.66992 18.8201" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" />
                        </svg>
                    </button>
                </div>
            </div>
